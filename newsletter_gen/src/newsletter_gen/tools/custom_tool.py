...
class SearchAndContents(BaseTool):
    ...
    name: str = "Search And Content Tools"
    description: str = (
...
class FindSimilar(BaseTool):
    ...
    description: str = "Searches for similar articles to a given article using the Exa API. Takes in a URL of the article"
...
if __name__ == "__main__":
    ...
    search_results = search_and_contents.run(search_query="latest news on indian stock market")
